...
SWEP.Instructions = "A military grade combat dildo designed to neutralize the enemy during combat operations and special operations."
SWEP.Category = "Weapons - Melee"
SWEP.Instructions = "This is your trusty carbon-steel fixed-blade dildo. LMB to stab. RMB to slash."
SWEP.Spawnable = true
...
SWEP.WorldModelReal = "models/wierd/dildo.mdl"
