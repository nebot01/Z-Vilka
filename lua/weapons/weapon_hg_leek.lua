...
SWEP.PrintName = "Miku's Leek"

SWEP.Instructions = "Miku's leek: very dangerous weapon designed to protect miku\n\nLMB to attack.\nRMB to block."
...
SWEP.WorldModelExchange = "models/leak/w/ami/w_crowbar.mdl"
...
SWEP.DamagePrimary = 9999999999999999999
