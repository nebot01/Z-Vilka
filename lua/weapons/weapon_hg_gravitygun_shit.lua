...
SWEP.Instructions = "Gordon forgot it in Kleiner's lab."
SWEP.Spawnable = true
...
if SERVER then
	function SWEP:InitAdd() -- Initialization stuff.
...
function SWEP:Deploy()
	...
	self:EmitSound("weapons/mmod/physcannon/physcannon_charge.wav") 
